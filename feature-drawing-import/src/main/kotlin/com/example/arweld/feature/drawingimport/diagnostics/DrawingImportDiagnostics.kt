...
enum class DrawingImportEvent(val eventName: String, val phase: String) {
    ...
    DECODE_INFO("drawing_import_decode_info", "pipeline"),
    RECTIFIED_SIZE_INFO("drawing_import_rectified_size_info", "pipeline"),
    TIME_BUDGET_EXCEEDED("drawing_import_time_budget_exceeded", "pipeline"),
