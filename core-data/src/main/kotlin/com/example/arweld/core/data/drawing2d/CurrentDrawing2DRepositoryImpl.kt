...
class CurrentDrawing2DRepositoryImpl @Inject constructor(
    ...
    override suspend fun saveCurrentDrawing(drawing: Drawing2D) = withContext(Dispatchers.IO) {
        ...
        val bytes = drawing.toCanonicalJson().toByteArray(Charsets.UTF_8)
        try {
    ...
    private fun drawingFile(): File = File(context.filesDir, CURRENT_DRAWING_PATH)
