...
val MIGRATION_4_5 = object : Migration(4, 5) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE sync_queue ADD COLUMN fileUri TEXT NOT NULL DEFAULT ''")
        database.execSQL("ALTER TABLE sync_queue ADD COLUMN mimeType TEXT NOT NULL DEFAULT ''")
        database.execSQL("ALTER TABLE sync_queue ADD COLUMN sizeBytes INTEGER NOT NULL DEFAULT 0")
    }
}

val MIGRATION_5_6 = object : Migration(5, 6) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE sync_queue ADD COLUMN lastAttemptAt INTEGER")
    }
}
