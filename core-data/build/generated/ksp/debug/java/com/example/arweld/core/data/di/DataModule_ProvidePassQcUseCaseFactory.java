...
public final class DataModule_ProvidePassQcUseCaseFactory implements Factory<PassQcUseCase> {
  ...
  public DataModule_ProvidePassQcUseCaseFactory(Provider<EventRepository> eventRepositoryProvider,
  ...
  @Override
  public PassQcUseCase get() {
    return providePassQcUseCase(eventRepositoryProvider.get(), evidenceRepositoryProvider.get(), authRepositoryProvider.get(), timeProvider.get(), deviceInfoProvider.get(), qcEvidencePolicyProvider.get());
  }

  public static DataModule_ProvidePassQcUseCaseFactory create(
  ...
  public static DataModule_ProvidePassQcUseCaseFactory create(
      ...
      Provider<DeviceInfoProvider> deviceInfoProvider,
      Provider<QcEvidencePolicy> qcEvidencePolicyProvider) {
    return new DataModule_ProvidePassQcUseCaseFactory(eventRepositoryProvider, evidenceRepositoryProvider, authRepositoryProvider, timeProvider, deviceInfoProvider, qcEvidencePolicyProvider);
  }

  public static PassQcUseCase providePassQcUseCase(EventRepository eventRepository,
    ...
    return Preconditions.checkNotNullFromProvides(DataModule.INSTANCE.providePassQcUseCase(eventRepository, evidenceRepository, authRepository, timeProvider, deviceInfoProvider, qcEvidencePolicy));
  }
}
